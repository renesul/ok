...
// ChannelFactory is a constructor function that creates a Channel from config and message events.
// Each channel subpackage registers one or more factories via init().
type ChannelFactory func(cfg *config.Config, bus *events.MessageBus) (Channel, error)
