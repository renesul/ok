...
// MemoryManager handles loading and saving conversation utils.
type MemoryManager struct {
	mediaStore   media.MediaStore
	maxMediaSize int
	retriever    *memory.Retriever // optional RAG retriever for indexing interactions
}
...
// RebuildMessages rebuilds the LLM message list from current session utils.
