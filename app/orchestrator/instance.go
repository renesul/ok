...
type AgentInstance struct {
	...
	ContextBuilder            *appctx.ContextBuilder
...
func NewAgentInstance(
	...
	sessionsManager := memory.NewSessionManager(sessionsDir)

	contextBuilder := appctx.NewContextBuilder(workspace)
	...
	thinkingLevel := types.ParseThinkingLevel(thinkingLevelStr)
...
func resolveAgentWorkspace(agentCfg *config.AgentConfig, defaults *config.AgentDefaults) string {
	...
	// Use the configured default workspace (respects OK_HOME)
