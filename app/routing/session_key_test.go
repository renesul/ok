...
func TestBuildAgentPeerSessionKey_DMScopeMain(t *testing.T) {
	got := BuildAgentPeerSessionKey(types.SessionKeyParams{
		AgentID: "main",
		Channel: "telegram",
		Peer:    &types.RoutePeer{Kind: "direct", ID: "user123"},
...
func TestBuildAgentPeerSessionKey_DMScopePerChannelPeer(t *testing.T) {
	got := BuildAgentPeerSessionKey(types.SessionKeyParams{
		...
		Channel: "telegram",
		Peer:    &types.RoutePeer{Kind: "direct", ID: "user123"},
		DMScope: types.DMScopePerChannelPeer,
	})
...
func TestBuildAgentPeerSessionKey_DMScopePerAccountChannelPeer(t *testing.T) {
	got := BuildAgentPeerSessionKey(types.SessionKeyParams{
		...
		AccountID: "bot1",
		Peer:      &types.RoutePeer{Kind: "direct", ID: "User123"},
		DMScope:   types.DMScopePerAccountChannelPeer,
	})
...
func TestBuildAgentPeerSessionKey_GroupPeer(t *testing.T) {
	got := BuildAgentPeerSessionKey(types.SessionKeyParams{
		AgentID: "main",
		Channel: "telegram",
		Peer:    &types.RoutePeer{Kind: "group", ID: "chat456"},
		DMScope: types.DMScopePerPeer,
	})
