...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.ok")
	assert.Equal(t, "/home/user/.ok/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.ok/workspace/file.txt", "/home/user/.ok")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".ok"), result)
}
