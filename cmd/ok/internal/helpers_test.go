...
func TestGetConfigPath(t *testing.T) {
	...
	got := GetConfigPath()
	want := filepath.Join("/tmp/home", ".ok", "config.json")

	assert.Equal(t, want, got)
}

func TestGetConfigPath_WithOK_HOME(t *testing.T) {
	t.Setenv("OK_HOME", "/custom/ok")
	t.Setenv("HOME", "/tmp/home")

	got := GetConfigPath()
	want := filepath.Join("/custom/ok", "config.json")

	assert.Equal(t, want, got)
}

func TestGetConfigPath_WithOK_CONFIG(t *testing.T) {
	t.Setenv("OK_CONFIG", "/custom/config.json")
	t.Setenv("OK_HOME", "/custom/ok")
	t.Setenv("HOME", "/tmp/home")
...
func TestGetConfigPath_Windows(t *testing.T) {
	...
	got := GetConfigPath()
	want := filepath.Join(testUserProfilePath, ".ok", "config.json")
...
func TestGetConfigPath_WithEnv(t *testing.T) {
	t.Setenv("OK_CONFIG", "/tmp/custom/config.json")
